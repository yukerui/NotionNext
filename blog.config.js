...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'cd8f4fc9b9cb4c63beddd51f6b157123',
  ...
  AUTHOR: 'yukerui', // 作者
  BIO: '搬砖人🧱', // 作者简介
  LINK: 'https://blog.930113.xyz', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_GITHUB: 'https://github.com/yukerui', // 你的github个人主页
  ...
  FONT: 'font-custom',
  CUSTOM_FONT_URL: ['https://fonts.font.im/css2?family=Ma+Shan+Zheng&display=swap'], // 自定义字体的CSS
  CUSTOM_FONT_SANS: ['"Times New Roman"', 'Ma Shan Zheng'], // 自定义无衬线字体
  CUSTOM_FONT_SERIF: ['"Times New Roman"', 'Ma Shan Zheng'], // 自定义衬线字体
